...
echo.
echo ===============================================
echo  Selesai. https://github.com/lordbyaku/PuzzleCam
echo ===============================================
echo.
...
:tarik_gagal
echo.
echo GAGAL saat git pull --rebase, biasanya karena bentrok dengan perubahan
echo di GitHub. Belum ada yang dikirim dan commit lokal Anda aman.
